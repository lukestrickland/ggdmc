...
RcppExport SEXP _ggdmc_remove_t0(SEXP rtSEXP, SEXP t0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type rt(rtSEXP);
    Rcpp::traits::input_parameter< double >::type t0(t0SEXP);
    rcpp_result_gen = Rcpp::wrap(remove_t0(rt, t0));
    return rcpp_result_gen;
END_RCPP
}
// ttf
arma::mat ttf(arma::mat drifts, arma::vec A, arma::vec b, arma::vec t0, double st0, unsigned int nmean_v, unsigned int n);
RcppExport SEXP _ggdmc_ttf(SEXP driftsSEXP, SEXP ASEXP, SEXP bSEXP, SEXP t0SEXP, SEXP st0SEXP, SEXP nmean_vSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(ttf(drifts, A, b, t0, st0, nmean_v, n));
    return rcpp_result_gen;
END_RCPP
}
// fptcdf
...
// n1PDFfixedt0
arma::vec n1PDFfixedt0(arma::vec rt, arma::vec A, arma::vec b, arma::vec mean_v, arma::vec sd_v, arma::vec t0);
RcppExport SEXP _ggdmc_n1PDFfixedt0(SEXP rtSEXP, SEXP ASEXP, SEXP bSEXP, SEXP mean_vSEXP, SEXP sd_vSEXP, SEXP t0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type rt(rtSEXP);
    ...
    Rcpp::traits::input_parameter< arma::vec >::type t0(t0SEXP);
    rcpp_result_gen = Rcpp::wrap(n1PDFfixedt0(rt, A, b, mean_v, sd_v, t0));
    return rcpp_result_gen;
END_RCPP
}
// n1PDFfixedt0_pda
...
// make_r
arma::mat make_r(arma::mat drifts, arma::vec A, arma::vec b, arma::vec t0, double st0, unsigned int nmean_v, unsigned int n, bool return_ttf, bool debug);
RcppExport SEXP _ggdmc_make_r(SEXP driftsSEXP, SEXP ASEXP, SEXP bSEXP, SEXP t0SEXP, SEXP st0SEXP, SEXP nmean_vSEXP, SEXP nSEXP, SEXP return_ttfSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type drifts(driftsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(make_r(drifts, A, b, t0, st0, nmean_v, n, return_ttf, debug));
    return rcpp_result_gen;
END_RCPP
}
// make_v
...
// rlba_norm
arma::mat rlba_norm(unsigned int n, arma::vec A, arma::vec b, arma::mat mean_v, arma::vec sd_v, arma::vec t0, double st0, bool posdrift, bool return_ttf, bool debug);
...
// n1PDF_gpu
NumericVector n1PDF_gpu(arma::vec x, double A, double b, arma::vec mean_v, arma::vec sd_v, double t0, int n, int nthread, int gpuid, double bw, bool debug);
...
// n1PDF_plba0_gpu
NumericVector n1PDF_plba0_gpu(arma::vec x, double A, double b, arma::vec mean_v, arma::vec sd_v, double t0, arma::vec mean_w, double rD, double swt, int n, int nthread, int gpuid, double bw, bool debug);
...
// n1PDF_plba1_gpu
NumericVector n1PDF_plba1_gpu(arma::vec x, double A, double b, arma::vec mean_v, arma::vec sd_v, double t0, arma::vec mean_w, double rD, double swt, int n, int nthread, int gpuid, double bw, bool debug);
...
// density_norm
arma::vec density_norm(arma::vec pVec, std::vector<std::string> pnames, arma::vec allpar, std::vector<std::string> parnames, arma::ucube model, std::string type, std::vector<std::string> dim1, std::vector<std::string> dim2, std::vector<std::string> dim3, arma::umat n1idx, arma::uvec ise, arma::umat cellidx, arma::vec RT, arma::uvec matchcell, arma::uvec isr1);
RcppExport SEXP _ggdmc_density_norm(SEXP pVecSEXP, SEXP pnamesSEXP, SEXP allparSEXP, SEXP parnamesSEXP, SEXP modelSEXP, SEXP typeSEXP, SEXP dim1SEXP, SEXP dim2SEXP, SEXP dim3SEXP, SEXP n1idxSEXP, SEXP iseSEXP, SEXP cellidxSEXP, SEXP RTSEXP, SEXP matchcellSEXP, SEXP isr1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type pVec(pVecSEXP);
    ...
    Rcpp::traits::input_parameter< arma::uvec >::type matchcell(matchcellSEXP);
    Rcpp::traits::input_parameter< arma::uvec >::type isr1(isr1SEXP);
    rcpp_result_gen = Rcpp::wrap(density_norm(pVec, pnames, allpar, parnames, model, type, dim1, dim2, dim3, n1idx, ise, cellidx, RT, matchcell, isr1));
    return rcpp_result_gen;
END_RCPP
}
// density_norm_pda
arma::vec density_norm_pda(arma::vec pVec, std::vector<std::string> pnames, arma::vec allpar, std::vector<std::string> parnames, arma::ucube model, std::string type, std::vector<std::string> dim1, std::vector<std::string> dim2, std::vector<std::string> dim3, arma::umat n1idx, arma::uvec ise, arma::umat cellidx, arma::vec RT, arma::uvec matchcell, arma::uvec isr1, int nsim, double bw, bool debug);
RcppExport SEXP _ggdmc_density_norm_pda(SEXP pVecSEXP, SEXP pnamesSEXP, SEXP allparSEXP, SEXP parnamesSEXP, SEXP modelSEXP, SEXP typeSEXP, SEXP dim1SEXP, SEXP dim2SEXP, SEXP dim3SEXP, SEXP n1idxSEXP, SEXP iseSEXP, SEXP cellidxSEXP, SEXP RTSEXP, SEXP matchcellSEXP, SEXP isr1SEXP, SEXP nsimSEXP, SEXP bwSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type pVec(pVecSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type bw(bwSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(density_norm_pda(pVec, pnames, allpar, parnames, model, type, dim1, dim2, dim3, n1idx, ise, cellidx, RT, matchcell, isr1, nsim, bw, debug));
    return rcpp_result_gen;
END_RCPP
}
// density_norm_gpu
...
// sumloglike
double sumloglike(arma::vec pVec, std::vector<std::string> pnames, arma::vec allpar, std::vector<std::string> parnames, arma::ucube model, std::string type, std::vector<std::string> dim1, std::vector<std::string> dim2, std::vector<std::string> dim3, arma::umat n1idx, arma::uvec ise, arma::umat cellidx, arma::vec RT, arma::uvec matchcell, arma::uvec isr1, int nsim, double bw, int ncore, int gpuid, bool debug);
RcppExport SEXP _ggdmc_sumloglike(SEXP pVecSEXP, SEXP pnamesSEXP, SEXP allparSEXP, SEXP parnamesSEXP, SEXP modelSEXP, SEXP typeSEXP, SEXP dim1SEXP, SEXP dim2SEXP, SEXP dim3SEXP, SEXP n1idxSEXP, SEXP iseSEXP, SEXP cellidxSEXP, SEXP RTSEXP, SEXP matchcellSEXP, SEXP isr1SEXP, SEXP nsimSEXP, SEXP bwSEXP, SEXP ncoreSEXP, SEXP gpuidSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type pVec(pVecSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type gpuid(gpuidSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(sumloglike(pVec, pnames, allpar, parnames, model, type, dim1, dim2, dim3, n1idx, ise, cellidx, RT, matchcell, isr1, nsim, bw, ncore, gpuid, debug));
    return rcpp_result_gen;
END_RCPP
}
// profile_rd
...
RcppExport SEXP _ggdmc_profile_norm(SEXP pVecSEXP, SEXP pnamesSEXP, SEXP allparSEXP, SEXP parnamesSEXP, SEXP modelSEXP, SEXP typeSEXP, SEXP dim1SEXP, SEXP dim2SEXP, SEXP dim3SEXP, SEXP n1idxSEXP, SEXP iseSEXP, SEXP cellidxSEXP, SEXP RTSEXP, SEXP matchcellSEXP, SEXP isr1SEXP, SEXP pnameSEXP, SEXP psSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type pVec(pVecSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type pname(pnameSEXP);
    Rcpp::traits::input_parameter< arma::vec >::type ps(psSEXP);
    rcpp_result_gen = Rcpp::wrap(profile_norm(pVec, pnames, allpar, parnames, model, type, dim1, dim2, dim3, n1idx, ise, cellidx, RT, matchcell, isr1, pname, ps));
    return rcpp_result_gen;
END_RCPP
}
// profile_norm_pda
...
// rplba1
arma::mat rplba1(int n, arma::vec A, arma::vec b, double t0, arma::vec mean_v, arma::vec mean_w, arma::vec sd_v, double rD, double swt, int ncore, bool debug);
...
// rplba1_test
arma::mat rplba1_test(unsigned int n, arma::vec A, arma::vec b, double t0, arma::vec mean_v, arma::vec mean_w, arma::vec sd_v, double rD, double swt, bool debug);
RcppExport SEXP _ggdmc_rplba1_test(SEXP nSEXP, SEXP ASEXP, SEXP bSEXP, SEXP t0SEXP, SEXP mean_vSEXP, SEXP mean_wSEXP, SEXP sd_vSEXP, SEXP rDSEXP, SEXP swtSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< unsigned int >::type n(nSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type swt(swtSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(rplba1_test(n, A, b, t0, mean_v, mean_w, sd_v, rD, swt, debug));
    return rcpp_result_gen;
END_RCPP
}
// rplba2
arma::mat rplba2(int n, arma::vec A, arma::vec b, double t0, arma::vec mean_v, arma::vec mean_w, arma::vec sd_v, arma::vec sd_w, double rD, double swt, int ncore, bool debug);
...
// rplba2_test
arma::mat rplba2_test(unsigned int n, arma::vec A, arma::vec b, double t0, arma::vec mean_v, arma::vec mean_w, arma::vec sd_v, arma::vec sd_w, double rD, double swt, int ncore, bool debug);
RcppExport SEXP _ggdmc_rplba2_test(SEXP nSEXP, SEXP ASEXP, SEXP bSEXP, SEXP t0SEXP, SEXP mean_vSEXP, SEXP mean_wSEXP, SEXP sd_vSEXP, SEXP sd_wSEXP, SEXP rDSEXP, SEXP swtSEXP, SEXP ncoreSEXP, SEXP debugSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< unsigned int >::type n(nSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type ncore(ncoreSEXP);
    Rcpp::traits::input_parameter< bool >::type debug(debugSEXP);
    rcpp_result_gen = Rcpp::wrap(rplba2_test(n, A, b, t0, mean_v, mean_w, sd_v, sd_w, rD, swt, ncore, debug));
    return rcpp_result_gen;
END_RCPP
}
// rplba3
arma::mat rplba3(int n, arma::vec A, arma::vec B, arma::vec C, arma::vec mean_v, arma::vec mean_w, arma::vec sd_v, arma::vec sd_w, double rD, double tD, double swt, double t0);
...
// n1PDF_plba1
arma::vec n1PDF_plba1(arma::vec x, arma::vec A, arma::vec b, arma::vec mean_v, arma::vec sd_v, double t0, arma::vec mean_w, double rD, double swt, int n, double h, int ncore, bool debug);
...
// n1PDF_plba2
arma::vec n1PDF_plba2(arma::vec x, arma::vec A, arma::vec b, arma::vec mean_v, arma::vec sd_v, double t0, arma::vec mean_w, arma::vec sd_w, double rD, double swt, int n, double h, int ncore, bool debug);
...
// n1PDF_plba3
arma::vec n1PDF_plba3(arma::vec x, int n, arma::vec A, arma::vec B, arma::vec C, arma::vec mean_v, arma::vec sd_v, arma::vec mean_w, arma::vec sd_w, double rD, double tD, double swt, double t0, double h);
...
RcppExport SEXP _ggdmc_PickChains(SEXP kSEXP, SEXP nSEXP, SEXP chainsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// ptnorm
arma::vec ptnorm(arma::vec q, double mean, double sd, double lower, double upper, bool lt, bool lp);
RcppExport SEXP _ggdmc_ptnorm(SEXP qSEXP, SEXP meanSEXP, SEXP sdSEXP, SEXP lowerSEXP, SEXP upperSEXP, SEXP ltSEXP, SEXP lpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(ptnorm(q, mean, sd, lower, upper, lt, lp));
    return rcpp_result_gen;
END_RCPP
}
// GetConstIdx
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ggdmc_density_norm", (DL_FUNC) &_ggdmc_density_norm, 15},
    ...
    {"_ggdmc_sumloglike", (DL_FUNC) &_ggdmc_sumloglike, 20},
    {"_ggdmc_profile_rd", (DL_FUNC) &_ggdmc_profile_rd, 17},
    {"_ggdmc_profile_norm", (DL_FUNC) &_ggdmc_profile_norm, 17},
    ...
    {"_ggdmc_rplba1_test", (DL_FUNC) &_ggdmc_rplba1_test, 10},
    {"_ggdmc_rplba2", (DL_FUNC) &_ggdmc_rplba2, 12},
    {"_ggdmc_rplba2_test", (DL_FUNC) &_ggdmc_rplba2_test, 12},
